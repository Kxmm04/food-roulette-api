...
if ($menu_name === "") {
    http_response_code(400);
    echo json_encode(["ok" => false, "message" => "กรุณาระบุชื่อเมนู"], JSON_UNESCAPED_UNICODE);
    exit;
}
if ($price <= 0) {
    http_response_code(400);
    echo json_encode(["ok" => false, "message" => "กรุณาระบุราคาให้ถูกต้อง"], JSON_UNESCAPED_UNICODE);
    exit;
}
